...
**Note**
Always make sure you make a copy of `.env.sample`, rename it to `.env`, and add in the necessary environement variables for both the JWT secret and the MongoDB connection string.
